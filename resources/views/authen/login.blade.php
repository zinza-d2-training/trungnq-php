    ...
    <section class="h-screen bg-neutral-100 mx-auto" style="max-width: 1440px">
        <div class="flex justify-center align-middle h-screen">
            <div class="container w-4/12 flex flex-col mx-auto bg-white my-auto rounded-lg " style="height: 768px;">
                <div class="flex item-center  items-center w-full  px-6 "
                ...
                @if (Session::has('error'))
                    <div class="text-red-500 text-center mt-5">{{ Session::get('error') }}</div>
                @endif
                <div class="flex flex-col mt-8 w-full">
                    <form action="{{ route('custom-login') }}" class="px-6" method="POST">
                        ...
                        <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')"
                            required autofocus />
                        <x-input id="password" class="block mt-5 w-full" type="password" name="password"
                ...
                <div class=" flex flex-row  gap-4  mb-4 mx-6 py-2 "
                    style="border: 2px solid #ddd; border-radius: inherit">
                    <div class="basis-1/4 ">

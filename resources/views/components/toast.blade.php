<div {{$attributes->merge(['class' =>'flex items-center w-full max-w-xs p-4 mb-4 text-gray-700 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 '])}} class="" role="alert">

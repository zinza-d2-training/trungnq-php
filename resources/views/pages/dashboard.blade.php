                ...
                <div class="gird grid-cols-12">
                    <div class="grid grid-cols-12 gap-4 h-20 border-b-2 border-x-2 ">
                        <div class="col-span-7 flex flex-col content-center my-auto ml-9">
                            <div>
                                <p class="font-bold">Topic name</p>
                                <p class="font-normal h-6 truncate">Lorem, ipsum dolor sit amet consectetur adipisicing
                                    elit. Nemo ullam assumenda deleniti in eaque, nostrum deserunt veritatis magnam quia
                                    dolorem accusamus, aperiam, natus incidunt! Amet saepe nam tempore labore reiciendis.
                                </p>
                            </div>
                        </div>
                        <div class="col-span-5 flex items-center">
        ...
        <div class="col-span-1 border-l-4 pl-2 ">
            ...
            <div class="flex flex-col gap-y-2.5 cursor-pointer">
                ...
                <a href="" class="h-6 text-sm truncate">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis
                    rerum suscipit alias molestias tempore, aperiam quas aliquid accusamus reprehenderit mollitia possimus
